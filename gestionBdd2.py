...
path = "/home/au/Documents/GitHub/MusicApp/"
...
class myDatabase:
    ...
    #     myQuery = self.dbQuery(f"SOURCE /home/au/Documents/GitHub/MusicApp/assets/bdd.sql")
...
if __name__ == '__main__':
    ...
    db.addArtist("Lana Del Rey", "Solo", "assets/ressources/artist_img/lane-del-rey.jpeg")
    ...
    db.addTrack("Bella", "Maitre Gims", "assets/ressources/musique/trm.mp3", "Mon coeur avait raison")
    db.addTrack("All Electric", "Nirvana", "assets/ressources/musique/trm.mp3", "Nevermind")
    db.addTrack("Critical", "Nirvana", "assets/ressources/musique/trm.mp3", "Nevermind")
    ...
    db.addTrack("School", "Nirvana", "assets/ressources/musique/trm.mp3", "Bleach")
    ...
    db.addTrack("American", "Lana Del Rey", "assets/ressources/musique/trm.mp3", "Paradise")
...
# create database music DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
# SOURCE /home/au/Documents/GitHub/MusicApp/assets/bdd.sql