...
function displayAlbum(myAlbum){
    ajaxRequest("GET", "php/request.php/artist?id_artist="+myAlbum["album-infos"][0]["id_artist"], (artist)=>{artistName = artist[0]["name_artist"];document.getElementById("album-artist-name").innerHTML = artistName;document.getElementById("album-page-artist-image").setAttribute("src", artist[0]["img_path"])})
